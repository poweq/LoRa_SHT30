...
/**
 * Structure defining a value describing a SHT3x device.
 */

typedef struct {
	/**
	 * Pointer to the storage location for the sampled temperature
	 */
	uint8_t SHT_30_Temperature_H;
  	uint8_t SHT_30_Temperature_L;
 	uint8_t SHT_30_Humidity_H; 
 	uint8_t SHT_30_Humidity_L; 

	/**
	 * Pointer to the storage location for the sampled humidity.
	 */
...
float Get_sht_temperature_and_humidity(sht3x_handle_t *handle, sht3x_value_t value); 
